      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="邮件标题" prop="emailTitle">
            <el-input v-model="formData.emailTitle" placeholder="请输入邮件标题" maxlength="200">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
      ...
      <el-row>
        <el-col :span="12"
          ><el-form-item label="发帖积分" prop="postIntegral">
            <el-input v-model="formData.postIntegral" placeholder="请输入发帖可以获得的积分">
            </el-input>
          </el-form-item>
          <el-form-item label="每天可发贴数量" prop="postDayCountThreshold">
            <el-input v-model="formData.postDayCountThreshold" placeholder="请输入每天可发帖数量">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="每天可上传图片数量" prop="dayImageUploadCount">
            <el-input v-model="formData.dayImageUploadCount" placeholder="请输入每天可上传图片数量">
            </el-input>
          </el-form-item>
          <el-form-item label="允许附件大小（MB）" prop="attachmentSize">
            <el-input v-model="formData.attachmentSize" placeholder="请输入附件允许最大大小">
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="评论积分" prop="commentIntegral">
            <el-input v-model="formData.commentIntegral" placeholder="请输入评论可以获得的积分">
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="每天可发评论数量" prop="commentDayCountThreshold">
            <el-input
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="每天可点赞数量" prop="likeDayCountThreshold">
            <el-input v-model="formData.likeDayCountThreshold" placeholder="请输入每天可点赞数量">
            </el-input>
          </el-form-item> </el-col
      ></el-row>
